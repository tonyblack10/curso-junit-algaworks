...
public class CadastroEditorComMockTest {
    ...
    class EdicaoComEditorValido {
        ...
        @Spy
        Editor editor = new Editor(1L, "Tony", "tony@email.com", BigDecimal.TEN, true);
        ...
        void Dado_um_editor_valido_Quando_editar_Entao_deve_alterar_editor_salvo() {
            Editor editorAtualizado = new Editor(1L, "Tony Costa", "tonycosta@email.com", BigDecimal.ZERO, false);
    ...
    class EdicaoComEditorInexistente {
        ...
        Editor editor = new Editor(100L, "Tony", "tony@email.com", BigDecimal.TEN, true);

        @BeforeEach
        void init() {
            Mockito.when(armazenamentoEditor.encontrarPorId(100L)).thenReturn(Optional.empty());
        }
